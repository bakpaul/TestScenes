...
def createScene(sofa_root_node : Sofa.Core.Node):
    ...
    sofa_root_node.addObject("FreeMotionAnimationLoop", name="FreeMotionAnimationLoop")
    sofa_root_node.addObject("GenericConstraintSolver", maxIterations=50, tolerance=1.0e-3)
    ...
    SLICERLogo.addObject("EigenSimplicialLDLT", name="LDLTLinearSolver", template="CompressedRowSparseMatrixd",  linearSystem="@A")
    ...
    SLICERLogo.addObject("TetrahedronFEMForceField", name="LinearElasticityFEM",  youngModulus=1, poissonRatio=0.3, method="large", computeVonMisesStress=2, showVonMisesStressPerNodeColorMap=True )
