...
def createScene(root):
    ...
    root.addObject("GenericConstraintSolver", maxIterations="50", multithreading='true', tolerance="1.0e-4")
    ...
    SOFALogo.addObject("TetrahedronFEMForceField", name="LinearElasticityFEM",  youngModulus="5", poissonRatio="0.45", method="large" )
